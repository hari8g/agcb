		...
		>
			...
			>
				...
				<div className="text-sm text-void-fg-3 mb-4">
					{type === 'default' ? `${modelName} comes packaged with Agentic_MPS, so you shouldn't need to change these settings.`
						: isUnrecognizedModel
							? `Model not recognized by Agentic_MPS.`
							: `Agentic_MPS recognizes ${modelName} ("${recognizedModelName}").`}
				</div>
...
export const OllamaSetupInstructions = ({ sayWeAutoDetect }: { sayWeAutoDetect?: boolean }) => {
	return <div className='prose-p:my-0 prose-ol:list-decimal prose-p:py-0 prose-ol:my-0 prose-ol:py-0 prose-span:my-0 prose-span:py-0 text-void-fg-3 text-sm list-decimal select-text'>
		...
		{sayWeAutoDetect && <div className=' pl-6'><ChatMarkdownRender string={`Agentic_MPS automatically detects locally running models and enables them.`} chatMessageLocation={undefined} /></div>}
	</div>
}
        ...
        `}
				...
				<main className="flex-1 p-6 select-none">
					...
					<div className='max-w-3xl'>
						...
						<h1 className='text-2xl w-full'>{`Agentic_MPS Settings`}</h1>
						...
						<div className='flex flex-col gap-12'>
							...
							<div className={shouldShowTab('localProviders') ? `` : 'hidden'}>
								<ErrorBoundary>
									...
									<h3 className={`text-void-fg-3 mb-2`}>{`Agentic_MPS can access any model that you host locally. We automatically detect your local models by default.`}</h3>
							...
							<div className={shouldShowTab('providers') ? `` : 'hidden'}>
								<ErrorBoundary>
									...
									<h3 className={`text-void-fg-3 mb-2`}>{`Agentic_MPS can access models from Anthropic, OpenAI, OpenRouter, and more.`}</h3>
								...
								<ErrorBoundary>
									...
									<div className='flex flex-col gap-y-8 my-4'>
										...
										<div>
											...
											<div className='text-sm text-void-fg-3 mt-1'>{`Tools are functions that LLMs can call. Edits and terminal commands auto-approve by default; enable MCP auto-approve only if you trust your MCP servers.`}</div>
											...
											<div className='my-2'>
												...
												<ErrorBoundary>
													<div className='my-2'>
														...
														<div className='text-sm text-void-fg-3 mt-1 ml-6'>
															{settingsState.globalSettings.autoAcceptLLMChanges
																? 'Changes are applied and accepted immediately with no review step.'
																: 'Changes are applied to the editor with green (additions) and red (deletions) highlights. Use Accept/Reject in the editor or the notification to approve.'}
														</div>
													</div>
												</ErrorBoundary>
												...
												<ErrorBoundary>
													<div className='my-2'>
														<div className='flex items-center gap-x-2'>
															<VoidSwitch
																size='xs'
																value={settingsState.globalSettings.enableLiveAgentEdits}
																onChange={(newVal) => voidSettingsService.setGlobalSetting('enableLiveAgentEdits', newVal)}
															/>
															<span className='text-void-fg-3 text-xs pointer-events-none'>Live agent file edits</span>
														</div>
														<div className='text-sm text-void-fg-3 mt-1 ml-6'>
															While the agent generates an edit, apply completed search/replace blocks into the open file so you see changes in real time.
														</div>
													</div>
												</ErrorBoundary>
											</div>
										...
										<div className='w-full'>
											...
											<div className='text-sm text-void-fg-3 mt-1'>{`Settings that control the visibility of Agentic_MPS suggestions in the code editor.`}</div>
							...
							<div className={`${shouldShowTab('general') ? `` : 'hidden'} flex flex-col gap-12`}>
								...
								<div>
									<ErrorBoundary>
										...
										<h4 className='text-void-fg-3 mb-4'>{`Transfer your editor settings into Agentic_MPS.`}</h4>
								...
								<div>
									...
									<h4 className='text-void-fg-3 mb-4'>{`Transfer Agentic_MPS settings and chats in and out of Agentic_MPS.`}</h4>
								...
								<div className='max-w-[600px]'>
									...
									<h4 className={`text-void-fg-3 mb-4`}>Very basic anonymous usage tracking helps us keep Agentic_MPS running smoothly. You may opt out below. Regardless of this setting, Agentic_MPS never sees your code, messages, or API keys.</h4>
...
Alternatively, place a \`.voidrules\` or \`.cursorrules\` file in the root of your workspace (Cursor-compatible).
								`} chatMessageLocation={undefined} />
									...
									<div className='my-4'>
										...
										<div className='text-void-fg-3 text-xs mt-1'>
											{`When disabled, Agentic_MPS will not include anything in the system message except for content you specified above.`}
										</div>
									</div>
								</div>
