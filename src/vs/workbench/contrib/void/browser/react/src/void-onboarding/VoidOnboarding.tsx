...
const MPS_LOGO_DARK_URI = FileAccess.asBrowserUri('vs/workbench/contrib/void/browser/media/mps-logo-dark.png').toString(true);
const MPS_LOGO_LIGHT_URI = FileAccess.asBrowserUri('vs/workbench/contrib/void/browser/media/mps-logo-light.png').toString(true);
...
const VoidIcon = () => {
	...
	useEffect(() => {
		// MPS key visual — tinted monochrome watermark
		const updateTheme = () => {
...
// 		title:
// 			div
// 				"How would you like to use Agentic_MPS?"
// 		content:
...
const VoidOnboardingContent = () => {
	...
	const lastPagePrevAndNextButtons = <div className="max-w-[600px] w-full mx-auto flex flex-col items-end">
		<div className="flex items-center gap-2">
			...
			>Enter Agentic_MPS</PrimaryActionButton>
		</div>
	</div>
		...
		0: <OnboardingPageShell
			content={
				<div className='flex flex-col items-center gap-8'>
					<div className="text-5xl font-light text-center">Welcome to MPS_AC</div>

					{/* MPS key visual */}
					<div className='w-full max-w-xl h-[30vh] mx-auto flex items-center justify-center'>
						{!isLinux && <VoidIcon />}
					</div>
