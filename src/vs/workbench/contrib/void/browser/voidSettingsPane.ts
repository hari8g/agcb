...
class VoidSettingsInput extends EditorInput {
	...
	override getName(): string {
		return nls.localize('voidSettingsInputsName', 'Agentic_MPS Settings');
	}
...
Registry.as<IEditorPaneRegistry>(EditorExtensions.EditorPane).registerEditorPane(
	EditorPaneDescriptor.create(VoidSettingsPane, VoidSettingsPane.ID, nls.localize('VoidSettingsPane', "Agentic_MPS Settings Pane")),
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			title: nls.localize2('voidSettings', "Agentic_MPS: Toggle Settings"),
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			title: nls.localize2('voidSettingsAction2', "Agentic_MPS: Open Settings"),
			f1: true,
			icon: Codicon.settingsGear,
		});
	}
...
MenuRegistry.appendMenuItem(MenuId.GlobalActivity, {
	...
	command: {
		id: VOID_TOGGLE_SETTINGS_ACTION_ID,
		title: nls.localize('voidSettingsActionGear', "Agentic_MPS Settings")
	},
	order: 1
});
