...
const acceptBG = new Color(new RGBA(155, 185, 85, .22)); // green highlight for pending AI additions
const rejectBG = new Color(new RGBA(255, 0, 0, .15)); // red highlight for pending AI deletions
