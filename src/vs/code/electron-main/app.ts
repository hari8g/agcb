...
import { registerAgenticMcpChannel } from '../../workbench/contrib/agentic/electron-main/mcp/mcpChannelRegistry.js';
/**
...
export class CodeApplication extends Disposable {
	...
	private initChannels(accessor: ServicesAccessor, mainProcessElectronServer: ElectronIPCServer, sharedProcessClient: Promise<MessagePortClient>): void {
		...
		const agenticRuntimeChannel = new AgenticRuntimeChannel();
		mainProcessElectronServer.registerChannel('agentic-channel-runtime', agenticRuntimeChannel);
		...
		registerAgenticMcpChannel(mcpChannel);
